...
class LNBoard():
    def __init__(self, i2c_gateway):
        ...
        self.rheo_isource_A_5   = rheostat( device=self.rheo_dev_isource_5,   channel=0 )
        self.rheo_isource_A_100 = rheostat( device=self.rheo_dev_isource_100, channel=0 )
        self.rheo_isource_B_5   = rheostat( device=self.rheo_dev_isource_5,   channel=1 )
        self.rheo_isource_B_100 = rheostat( device=self.rheo_dev_isource_100, channel=1 )
